    ...
    <Grid container spacing={2}>
      <Card sx={style}>
        ...
        <CardContent sx={{
          ...
          <Grid item xs={12} mb={1}>  
            <FormControl fullWidth>
              <FormLabel id="tarefa_descricao_helper_text">Descrição da Tarefa.</FormLabel>
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2} sx={{display: 'flex', gap: 1}}>
              <Grid item xs={1}>
                <Button size="medium" variant="contained" color="success" onClick={handleEditar}>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="medium" variant="outlined" color='error' onClick={handleCloseEditar}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
