  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        ...
        <CardContent sx={{display: 'flex', gap: 1}}>
            <Button size="medium" variant="contained" color="success" onClick={handleOpen}>Criar Tarefa</Button>
            <Button size="medium" variant="outlined" color="error">Cancelar</Button>
      </CardContent> 
    </Card>
    <div>
      <Modal
