        ...
        <CardContent sx={{
          ...
          <Grid item xs={12} mb={1}>
            <FormControl fullWidth>
              <FormLabel id="tarefa_titulo_helper_text">Título da Tarefa.</FormLabel>
              <Input id="tarefa_titulo" aria-describedby="tarefa_titulo_helper_text" value={tituloTarefa} required onChange={e => { setTituloTarefa(e.target.value) }} />
            </FormControl>
          </Grid>
          <Grid item xs={12} mb={1}>  
            <FormControl fullWidth>
              <FormLabel id="tarefa_titulo_helper_text">Descrição</FormLabel>
              <Input id="tarefa_descricao" aria-describedby="tarefa_descricao_helper_text" value={descricaoTarefa} required onChange={e => { setDescricaoTarefa(e.target.value) }}  />
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                <FormLabel id="tarefa_inicio_helper_text">Início da Tarefa.</FormLabel>
            ...
            <Grid item xs={3}>  
              <FormControl>
                <FormLabel id="tarefa_fim_helper_text">Fim da Tarefa.</FormLabel>
            ...
            <Grid container spacing={2} pl={2} mt={2} sx={{display: 'flex', gap: 1}}>
              <Grid item xs={1}>
                <Button size="medium" variant="contained" color="success" onClick={handleSalvar}>Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
